...
plot(women)
abline(lm(women$weight ~ women$height), col='red', lty=2, lwd=4) #line of best fit
...
quantile(women$height, seq(0,1,.1)) #decile
quantile(women$height, seq(0,1,.01)) #percentile
...
hist(women$height, breaks=5, col=1:7)
