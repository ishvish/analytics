...
rules
inspect (rules[1:5])
# for Rule [3] 60% of people who bought root veg, onions also bought other veggies
#{root vegetables,onions, other vegetables} bought 56 times

#Sort Rules by confidence, lift and see the data
#Lift the higher the better
